 ...
 *
 * Secure RPC endpoint configuration with validation
 */
...
export class EthereumRpc implements ICredentialType {
  ...
  properties: INodeProperties[] = [
    ...
    },
    {
      ...
      placeholder: "1000",
      description:
        "Maximum number of blocks to query in a single request. Used to prevent timeouts.",
    },
    {
  ...
  async authenticate(
    ...
    if (
      ...
      try {
        const customHeaders = JSON.parse(credentials.customHeaders as string);
